...
**[Играть в браузере](https://AwsomeSauci.github.io/PlinkoHG/)** — HTML5-версия на GitHub Pages.

Опубликован release-билд для `wasm-web`. Готовые файлы находятся в ветке `gh-pages`; их размещает встроенный процесс GitHub Pages в Actions. Публикация разовая: изменения в `main` не пересобирают игру автоматически.
